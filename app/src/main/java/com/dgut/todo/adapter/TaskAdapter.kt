...
import com.dgut.todo.utils.views.recyclerview.itemdrag.ItemTouchHelperAdapter
import kotlinx.android.synthetic.main.row_task.view.*
import java.util.*


class TaskAdapter(private val mContext: Context, var mArrayList: ArrayList<TaskModel>) :
